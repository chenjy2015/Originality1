package app.originality.com.originality.config;
...
public class Contants {
    ...
    /**
     * facebook 图片处理框架 URI head
     */
    //远程图片
    public static final String FACEBOOK_URI_HEAD_HTTP = "http://";
    public static final String FACEBOOK_URI_HEAD_HTTPS = "https://";
    //本地文件
    public static final String FACEBOOK_URI_HEAD_LOCAL = "file://";
    //Content provider
    public static final String FACEBOOK_URI_HEAD_CONTENT = "content://";
    //asset目录下的资源
    public static final String FACEBOOK_URI_HEAD_ASSET = "asset://";
    //res目录下的资源
    public static final String FACEBOOK_URI_HEAD_RES = "res://";
