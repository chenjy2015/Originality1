package app.originality.com.originality.util.view;
...
import app.originality.com.originality.widget.carousel_figure.DecoratorViewPager;
...
public class ImageCycleView extends LinearLayout {
    ...
    public ImageCycleView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.ad_cycle_view_kye, this);
